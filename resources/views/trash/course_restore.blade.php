...
<div class="sidebar">
        ...
        <ul class="nav-list">
          <li>
            <form action="{{route('courses.restore.search')}}" method="POST">
              @csrf
              @method('POST')
 ...
 <img src="{{URL('images/admin.svg')}}" alt="Users" style="width: 150px;margin-left: 625px">
    ...
    <div class="box">
        ...
        <a class="href" href="{{ route('course.restore', [ 'id'=> $course->id]) }}"><img class="restore"src="{{URL('images/restore.png')}}" alt="folder"></a>

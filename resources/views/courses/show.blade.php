...
<body>
    ...
    <span class="h2" id="h"> Nmae  :</span>  <span class="h3" id="hh">{{$courses->name}}</span>
    <br><br>
   ...
   <br><br>
   <span class="h2" id="h"> Depends on the Subject : </span> <span class="h3" id="hh"> {{$courses ->Course->name}}</span>
   <br><br>
   <span class="h2" id="h"> Professor Subject : </span> <span class="h3" id="hh"> {{$courses ->professor->name}}</span>
   <br><br>
<a href="{{route('courses.index')}}"><button class="btn btn-success" type="submit"> Back</button> </a>
